...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { assunto: @contato.assunto, email: @contato.email, nome: @contato.nome } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { assunto: @contato.assunto, email: @contato.email, nome: @contato.nome } }
